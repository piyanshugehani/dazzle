...
export function MarqueeDemo() {
  return (
    <div className="sm:mt-[-10] relative flex md:h-[500px] w-full flex-col items-center justify-center overflow-hidden bg-[#ffefda] rounded-lg shadow-md md:shadow-[0px_0px_10px_rgba(0,0,0,0.15)]">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-1/5 bg-gradient-to-r from-[#f5ede4] dark:from-[#E6D0B3]"></div>
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/5 bg-gradient-to-l from-[#fdf3e9] dark:from-[#E6D0B3]"></div>
    </div>
  );
}

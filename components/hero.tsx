      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 rounded-full bg-button p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
